...
foreach($activeWorkflows as $workflow){
    ...
    ?>
        ...
        <small class="error-message black text-center border p-2 m-width-200">Заказ на согласовании!</small>
        <?return;
...
<form id = "catalog-order-approval-form" data-ajax-default-content-updater="refresh">
